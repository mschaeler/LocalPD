...
public class CentralityResult extends Results{
	double[] all_eps;
	ArrayList<Double> all_metrics;
	
	public CentralityResult(String name) {
		super(name);
	}
	public CentralityResult(String name, double[] all_eps, ArrayList<Double> all_metrics) {
		this(name);
